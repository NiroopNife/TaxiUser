...
//            Toast.makeText(SignUpActivity.this, entityBuilder.toString(), Toast.LENGTH_SHORT).show();
...
//                        Common.LoginCall(SignUpActivity.this, loginParams, ProgressDialog, cusRotateLoading, edit_password.getText().toString());
                        ...
                        ProgressDialog.cancel();
                        cusRotateLoading.stop();
                        Toast.makeText(SignUpActivity.this, resObj.getString("status"), Toast.LENGTH_SHORT).show();
