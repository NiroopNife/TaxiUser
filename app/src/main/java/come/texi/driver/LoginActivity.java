...
public class LoginActivity extends AppCompatActivity {
    ...
    RelativeLayout layout_signin, layout_sign_up;
    RelativeLayout layout_forgot;
    TextView txt_forgot_pass;
    RelativeLayout layout_show_hide;
    TextView txt_hide_show,txt_signin,txt_sign_in_logo, text_register;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout_sign_up = findViewById(R.id.layout_signup);
